...
# Исправление: добавляем калькуляцию через bc с корректными знаками доллара
...
# Исправление: оборачиваем значения в кавычки для предотвращения поломки JSON-синтаксиса
